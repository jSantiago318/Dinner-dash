...
public class GameState extends State {
    ...
    public GameState(Handler handler){
        ...
        BaseCounter[] Counters = {
                new PlateCounter(0,600,handler),
                new PineCounter(BaseCounter.DEFAULTCOUNTERWIDTH,600,handler),
                new PickleCounter(BaseCounter.DEFAULTCOUNTERWIDTH*2,600,handler),
                new StoveCounter(BaseCounter.DEFAULTCOUNTERWIDTH*3,600,handler),
                new KetchupCounter(BaseCounter.DEFAULTCOUNTERWIDTH*4,600,handler),
                new TomatoCounter(BaseCounter.DEFAULTCOUNTERWIDTH*5, 600, handler),
                new BreadCounter(BaseCounter.DEFAULTCOUNTERWIDTH*6, 600, handler),
                new TopBreadCounter(BaseCounter.DEFAULTCOUNTERWIDTH*7, 600, handler),
                new AbilityCounter(BaseCounter.DEFAULTCOUNTERWIDTH*8, 600, handler)
        };
